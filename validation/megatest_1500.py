...
import matplotlib
import os
from validation.utils import pose_auc,  compute_symmetrical_epipolar_errors, compute_pose_error, compute_relative_pose, estimate_pose, dynamic_alpha

##############################
from modules.vudnet import *
from validation.vudnet_helper import *
##############################
            ...
            for scene_ind in range(len(self.scenes)):
                ...
                for pairind in tqdm.tqdm(pair_inds):
                    ...
                    if ret is not None:
                        ...
                        e_pose = max(e_t, e_R)
                    #print("e_t: {:.2f}, e_R: {:.2f}, e_pose: {:.2f}".format(e_t, e_R, e_pose))
                    tot_e_t.append(e_t)
                    tot_e_R.append(e_R)
...
def parse_arguments():
    ...
    parser.add_argument("--data_root", type=str, default="./datasets/megadepth_test_1500", help="Path to the MegaDepth dataset.")
