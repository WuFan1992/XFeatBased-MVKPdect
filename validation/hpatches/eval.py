...
import torch
import numpy as np
from validation.hpatches.extract import extract_method
...
n_i = 52
n_v = 56
cache_dir = 'datasets/hseq/cache'
dataset_path = 'datasets/hseq/hpatches-sequences-release'
...
if __name__ == '__main__':
    ...
    if os.path.exists(cache_file):
        ...
        errors = benchmark_features(
            read_function
        )
        """
        np.save(
            cache_file,
            errors, allow_pickle=True
        )
        """
